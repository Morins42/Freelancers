...
<html lang="en">
    <head>
        ...
        <!-- base css -->
        <link rel="stylesheet" media="screen, print" href="css2/vendors.bundle.css">
        <link rel="stylesheet" media="screen, print" href="css2/app.bundle.css">
    ...
    <body class="mod-bg-1 ">
            ...
            <div class="page-inner">
                ...
                <aside class="page-sidebar">
                    <div class="page-logo">
                            ...
                            <span class="page-logo-text mr-1">FreeLancer Admin  </span>
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        <div class="info-card">
                            ...
                            <div class="info-card-text">
                                ...
                                <span class="d-inline-block text-truncate text-truncate-sm">Victoria, Tamaulipas</span>
                            </div>
                        ...
                        <ul id="js-nav-menu" class="nav-menu">
                            ...
                            <li class="nav-title">Tools y Components</li>
                            <li>
        ...
        <script src="js2/vendors.bundle.js"></script>
        <script src="js2/app.bundle.js"></script>
    </body>
</html>
